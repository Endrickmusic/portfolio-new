...
function Page({ title, paragraphs, className = "" }) {
  return (
...
export default function ScrollContent() {
  ...
  useFrame(() => {
    // We can access scroll.offset here (0 to 1)
    // For now, just log it to see it working
    if (scroll.offset !== undefined) {
      console.log("Scroll progress:", scroll.offset.toFixed(3))
    }
  })
