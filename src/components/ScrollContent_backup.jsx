...
export default function ScrollContent() {
  ...
  const controls = useControls(
    "Content",
    {
          ...
          Desktop: folder(
            {
              ...
              deskW1DescWidth: { value: 1.5, min: 0.5, max: 3.0, step: 0.1 },
            },
            { collapsed: true }
          ),
          Tablet: folder(
            {
              ...
              tabW1DescWidth: { value: 1.3, min: 0.5, max: 3.0, step: 0.1 },
            },
            { collapsed: true }
          ),
          Mobile: folder(
            {
              ...
              mobW1Y: { value: -1.02, min: -3, max: 0, step: 0.01 },
              mobW1TitleX: { value: -0.63, min: -3, max: 3, step: 0.01 },
              mobW1TitleY: { value: -1.7, min: -4, max: -1, step: 0.01 },
              mobW1TitleWidth: { value: 0.24, min: 0.1, max: 2, step: 0.01 },
              mobW1DescX: { value: 1.0, min: -3, max: 3, step: 0.01 },
              mobW1DescY: { value: -0.81, min: -3, max: 0, step: 0.01 },
              mobW1DescWidth: { value: 1.0, min: 0.5, max: 2.5, step: 0.1 },
            },
            { collapsed: true }
          ),
        },
      ...
      "Work 2": folder({
        Desktop: folder(
          {
            ...
            deskW2DescWidth: { value: 1.5, min: 0.5, max: 3.0, step: 0.1 },
          },
        ...
        Tablet: folder(
          {
            ...
            tabW2DescWidth: { value: 1.3, min: 0.5, max: 3.0, step: 0.1 },
          },
        ...
        Mobile: folder(
          {
            mobW2X: { value: -0.08, min: -3, max: 3, step: 0.01 },
            mobW2Y: { value: -1.82, min: -3, max: 0, step: 0.01 },
            mobW2TitleX: { value: -0.57, min: -3, max: 3, step: 0.01 },
            mobW2TitleY: { value: -2.14, min: -3, max: 0, step: 0.01 },
            mobW2TitleWidth: { value: 0.65, min: 0.1, max: 2, step: 0.01 },
            mobW2DescX: { value: -0.4, min: -3, max: 3, step: 0.01 },
            mobW2DescY: { value: -1.1, min: -3, max: 0, step: 0.01 },
            mobW2DescWidth: { value: 0.8, min: 0.5, max: 2.5, step: 0.1 },
          },
      ...
      "Work 3": folder({
        Desktop: folder(
          {
            ...
            deskW3DescWidth: { value: 1.5, min: 0.5, max: 3.0, step: 0.1 },
          },
        ...
        Tablet: folder(
          {
            ...
            tabW3DescWidth: { value: 1.3, min: 0.5, max: 3.0, step: 0.1 },
          },
        ...
        Mobile: folder(
          {
            mobW3X: { value: -0.18, min: -3, max: 3, step: 0.01 },
            mobW3Y: { value: -2.67, min: -3, max: 0, step: 0.01 },
            mobW3TitleX: { value: -0.78, min: -3, max: 3, step: 0.01 },
            mobW3TitleY: { value: -2.95, min: -3, max: 0, step: 0.01 },
            mobW3TitleWidth: { value: 1.0, min: 0.1, max: 2, step: 0.01 },
            mobW3DescX: { value: -0.44, min: -3, max: 3, step: 0.01 },
            mobW3DescY: { value: -1.56, min: -3, max: 0, step: 0.01 },
            mobW3DescWidth: { value: 1.0, min: 0.5, max: 2.5, step: 0.1 },
          },
        ...
        Desktop: folder(
          {
            ...
            deskPlayY: { value: -3.5, min: -5, max: 0, step: 0.01 },
          },
  ...
  // 🎛️ Development helper: Enable value extraction in browser console
  // This adds levaExtractor functions to window object in development
  useLevaExtractor(controls)
